...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'user_valid_akun' => \App\Http\Middleware\UserValidAkun::class,
        'user_valid_role' => \App\Http\Middleware\UserValidRole::class,
        'role_delete_doc' => \App\Http\Middleware\RoleDeleteDoc::class,
        'role_table_files' => \App\Http\Middleware\RoleTableFiles::class,
        'role_pralop' => \App\Http\Middleware\RolePraLop::class,
