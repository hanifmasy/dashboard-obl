<x-layout bodyClass="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            <!-- Navbar -->
            <x-navbars.navs.auth titlePage="REWARD / WITEL OBL"></x-navbars.navs.auth>
            <!-- End Navbar -->
                      ...
                      if( user_in_is.role_id === 4 || user_in_is.role_id === 5 ){
                        if( user_in_is.nama_witel && user_in_is.nama_witel !== '' && user_in_is.nama_witel === value.f1_witel ){
                          ...
                          <tr >
                            ...
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_cancel+`</b></a></td>
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_done+`</b></a></td>
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_obl+`</b></a></td>
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_witel+`</b></a></td>
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_rev_now+`</b></a></td>
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_doc_rev+`</b></a></td>
                            <td><a href="{{ route('obl.tables') }}?wl=`+value.f1_witel+`&cl={{ Crypt::encryptstring('a') }}" class="text-black"><b>`+value.total_prs_rev+`</b></a></td>
                          </tr>
                          `;
                        }
                        else{
