                ...
                <div class="row">
                    <div class="col-12 mx-auto">
                        <div class="card my-4">
                            ...
                            @csrf
                            @if( isset($user_in_is) )
                              @if( $user_in_is->role_id === 4 || $user_in_is->role_id === 8 || $user_in_is->role_id === 9 )
                                              ...
                                              <tr >
                                                  ...
                                                  <td>
                                                    <select class="" name="p0_pemeriksa" id="p0_pemeriksa">
                                                      ...
                                                      <option value="business_service" {{ $witel_form->p0_pemeriksa == 'business_service' ? ' selected="selected"' : '' }}>Manager BUSINESS service Witel {{ $witel_form->f1_witel ? $witel_form->f1_witel : ''  }}</option>
                                                      <option value="government_service" {{ $witel_form->p0_pemeriksa == 'government_service' ? ' selected="selected"' : '' }}>Manager GOVERNMENT service Witel {{ $witel_form->f1_witel ? $witel_form->f1_witel : ''  }}</option>
                                                      <option value="enterprise_service" {{ $witel_form->p0_pemeriksa == 'enterprise_service' ? ' selected="selected"' : '' }}>Manager ENTERPRISE service Witel {{ $witel_form->f1_witel ? $witel_form->f1_witel : ''  }}</option>
                                                    </select>
                                                  </td>
                                              </tr>
                                              <tr >
                                      ...
                                      <table id="table-input-obl" class="table align-items-center mb-0" cellspacing="0" cellpadding="0">
                                          ...
                                          <tbody>
                                              ...
                                              <tr >
                                                  ...
                                                  <td>
                                                    <input style="width:350px;" type="text" name="p0_nomor_p0" id="p0_nomor_p0"  value="{{ $witel_form->p0_nomor_p0 ? $witel_form->p0_nomor_p0 : '' }}" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                      <input type="text" name="p0_nik_am" id="p0_nik_am" style="width:350px;" value="{{ $witel_form->p0_nik_am ? $witel_form->p0_nik_am : '' }}" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                    <input type="text" name="p0_nik_manager" id="p0_nik_manager" style="width:350px;" value="{{ $witel_form->p0_nik_manager ? $witel_form->p0_nik_manager : '' }}" disabled>
                                              ...
                                              <tr >
                                                  ...
                                                  <td>
                                                    <select class="" name="p0_pemeriksa" id="p0_pemeriksa">
                                                      <option value="" disabled selected>Pilih Pemeriksa</option>
                                                      <option disabled value="business_service" {{ $witel_form->p0_pemeriksa == 'business_service' ? ' selected="selected"' : '' }}>Manager BUSINESS service Witel {{ $witel_form->f1_witel ? $witel_form->f1_witel : ''  }}</option>
                                                      <option disabled value="government_service" {{ $witel_form->p0_pemeriksa == 'government_service' ? ' selected="selected"' : '' }}>Manager GOVERNMENT service Witel {{ $witel_form->f1_witel ? $witel_form->f1_witel : ''  }}</option>
                                                      <option disabled value="enterprise_service" {{ $witel_form->p0_pemeriksa == 'enterprise_service' ? ' selected="selected"' : '' }}>Manager ENTERPRISE service Witel {{ $witel_form->f1_witel ? $witel_form->f1_witel : ''  }}</option>
                                                    </select>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  ...
                                                  <td>
                                                       <input type="text" name="p0_nik_gm" id="p0_nik_gm" style="width:350px;" value="{{ $witel_form->p0_nik_gm ? $witel_form->p0_nik_gm : '' }}" disabled>
                                                  </td>
                                              </tr>
                                              <tr ><td colspan="2"><hr></td></tr>
                                              <tr >
                                              ...
                                              <tr >
                                                  ...
                                                  <td>
                                                       <input type="text" name="p1_nomor_p1" id="p1_nomor_p1" value="{{ $witel_form->p1_nomor_p1 ? $witel_form->p1_nomor_p1 : '' }}" style="width:350px;" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                       <input type="date" name="p1_tgl_delivery" id="p1_tgl_delivery" autocomplete="off" value="{{ $witel_form->tgl_delivery_p1 ? $witel_form->tgl_delivery_p1 : '' }}" style="width:350px;" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                       <input type="text" name="p1_lokasi_instal" id="p1_lokasi_instal" autocomplete="off" value="{{ $witel_form->p1_lokasi_instal ? $witel_form->p1_lokasi_instal : '' }}" style="width:350px;" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                    <select name="p1_skema_bisnis" id="p1_skema_bisnis">
                                                        <option value="" disabled selected>Pilih Skema Bisnis</option>
                                                        <option disabled value="sewa_murni" {{ $witel_form->p1_skema_bisnis == 'sewa_murni' ? ' selected="selected"' : '' }}>Sewa Murni</option>
                                                        <option disabled value="sewa_beli" {{ $witel_form->p1_skema_bisnis == 'sewa_beli' ? ' selected="selected"' : '' }}>Sewa Beli</option>
                                                        <option disabled value="beli_putus" {{ $witel_form->p1_skema_bisnis == 'beli_putus' ? ' selected="selected"' : '' }}>Pengadaan Beli Putus</option>
                                                    </select>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  ...
                                                  <td>
                                                    <select name="p1_skema_bayar" id="p1_skema_bayar">
                                                        <option value="" disabled selected>Pilih Skema</option>
                                                        <option disabled value="otc" {{ $witel_form->p1_skema_bayar == 'otc' ? ' selected="selected"' : '' }}>OTC</option>
                                                        <option disabled value="recurring" {{ $witel_form->p1_skema_bayar == 'recurring' ? ' selected="selected"' : '' }}>Recurring</option>
                                                        <option disabled value="termin" {{ $witel_form->p1_skema_bayar == 'termin' ? ' selected="selected"' : '' }}>Termin</option>
                                                        <option disabled value="otc_recurring" {{ $witel_form->p1_skema_bayar == 'otc_recurring' ? ' selected="selected"' : '' }}>OTC Recurring</option>
                                                    </select>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  ...
                                                  <td>
                                                    <select name="p1_mekanisme_bayar" id="p1_mekanisme_bayar">
                                                        <option value="" disabled selected>Pilih Mekanisme</option>
                                                        <option disabled value="back_to_back" {{ $witel_form->p1_mekanisme_bayar == 'back_to_back' ? ' selected="selected"' : '' }}>Back To Back</option>
                                                        <option disabled value="non_back_to_back" {{ $witel_form->p1_mekanisme_bayar == 'non_back_to_back' ? ' selected="selected"' : '' }}>Non Back To Back</option>
                                                    </select>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  ...
                                                  <td>
                                                       Mulai: <input type="date" name="p1_tgl_kontrak_mulai" id="p1_tgl_kontrak_mulai" value="{{ $witel_form->tgl_kontrak_mulai_p1 ? $witel_form->tgl_kontrak_mulai_p1 : '' }}" disabled>
                                                       Hingga: <input type="date" name="p1_tgl_kontrak_akhir" id="p1_tgl_kontrak_akhir" value="{{ $witel_form->tgl_kontrak_akhir_p1 ? $witel_form->tgl_kontrak_akhir_p1 : '' }}" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                       <input type="date" name="p1_tgl_doc_plggn" id="p1_tgl_doc_plggn" autocomplete="off" value="{{ $witel_form->tgl_doc_plggn_p1 ? $witel_form->tgl_doc_plggn_p1 : '' }}" style="width:350px;" disabled>
                                                  </td>
                                              </tr>
                                              <tr >
                                                  <td>
                                                  ...
                                                  <td>
                                                      <input class="rupiahs" type="text" name="p1_estimasi_harga" id="p1_estimasi_harga" style="width:350px;" placeholder="Rp. xxx.xxx.xxx.-" value="{{ $witel_form->p1_estimasi_harga ? $witel_form->p1_estimasi_harga : '' }}" disabled>
                                                  </td>
                                              </tr>
                                              <tr ><td colspan="2"><br></td></tr>
                                              <tr ><td colspan="2">
