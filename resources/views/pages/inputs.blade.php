                                            ...
                                            <tr class="filterKontrak">
                                                ...
                                                <td>
                                                        <select name="f1_status_sm" id="f1_status_sm">
                                                            <option value="" disabled selected>Pilih Status</option>
                                                            <option value="close" {{ old('f1_status_sm') == 'close' ? ' selected="selected"' : '' }}>CLOSE</option>
                                                            <option value="not_close" {{ old('f1_status_sm') == 'not_close' ? ' selected="selected"' : '' }}>NOT CLOSE</option>
                                                        </select>
                                                </td>
                                            </tr>
                                            <tr class="filterKontrak">
